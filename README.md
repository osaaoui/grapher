Construction d'une application qui affiche le graphique d'équations mathématiques. Le projet s'appuie sur la bibliothèque javascript  JSXgraph (http://jsxgraph.uni-bayreuth.de/wp/index.html)
